...
/**
  Used internally by RabbitMQ ConnectionFactory doesn't presently provide a way to configure multiple hosts; since pekko-rabbitmq just uses ConnectionFactory.newConnection().
  */
